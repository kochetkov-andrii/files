...
if(isset($_REQUEST['submit'])){
    ...
    if(!$name || !$telephone || !$time){
        $error = "<script>alert('Ви не ввели потрібні данні')</script>";
    }
    else{
        $query = "INSERT INTO telephone (id, name, telephone, time) VALUES ('', '$name', '$telephone', '$time')";
...
<html>
    <head>
        ...
        <title>Замовлення дзвінка</title>
