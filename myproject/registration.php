...
if(isset($_REQUEST['submit'])){
    ...
    if(!$name || !$email || !$time || !$date){
        ...
        $query = "INSERT INTO users (id, name, email, time, date) VALUES ('', '$name', '$email', '$time', '$date')";
...
<html>
    ...
    <body>
      ...
      <form class="order" id="form" method="POST">
        <input type="text" name="name" placeholder="Ім'я та прізвище"/><br>
        <input type="text" name="email" placeholder="E-mail"/><br>
        <input type="time" name="time"/><br>
        <input type="date" name="date"/><br><br>
        <input type="submit" name="submit" id="submit" value="Замовити">
      </form>
      </center>
            <div class="footer">
